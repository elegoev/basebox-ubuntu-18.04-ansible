...
- [elegoev/ubuntu-18.04-ansible](https://app.vagrantup.com/elegoev/boxes/ubuntu-18.04-ansible)
...
### Vagrantfile
    ...
    Vagrant.configure("2") do |config|
      ...
      $basebox_name="ubuntu-18.04-ansible-test"
      $basebox_hostname="ubuntu-1804-ansible-test"
      $src_image_name="elegoev/ubuntu-18.04-ansible"
      $vb_group_name="basebox-ansible-test"
